...
- cpu_1 legge dalla riga 0 alla riga 9 (estremi inclusi) --> totale 10 righe;
- cpu_2 legge dalla riga 6 alla riga 16 (estremi inclusi) --> totale 11 righe;
- cpu_3 legge dalla riga 13 alla riga 25 (estremi inclusi) --> totale 13 righe;
- cpu_4 legge dalla riga 22 alla riga 35 (estremi inclusi) --> totale 14 righe;
...
max1                   (address: SHARED_ONCHIP_BASE+1301) (E' UN INTERO! GLI HO LASCIATO 4 BYTES)
max2                   (address: SHARED_ONCHIP_BASE+1305) (E' UN INTERO! GLI HO LASCIATO 4 BYTES)
max3                   (address: SHARED_ONCHIP_BASE+1309) (E' UN INTERO! GLI HO LASCIATO 4 BYTES)
max4                   (address: SHARED_ONCHIP_BASE+1313) (E' UN INTERO! GLI HO LASCIATO 4 BYTES)
offsetX1               (address: SHARED_ONCHIP_BASE+1317)	
offsetY1               (address: SHARED_ONCHIP_BASE+1318)
offsetX2               (address: SHARED_ONCHIP_BASE+1319)	
offsetY2               (address: SHARED_ONCHIP_BASE+1320)
offsetX3               (address: SHARED_ONCHIP_BASE+1321)	
offsetY3               (address: SHARED_ONCHIP_BASE+1322)
offsetX4               (address: SHARED_ONCHIP_BASE+1323)	
offsetY4               (address: SHARED_ONCHIP_BASE+1324)
